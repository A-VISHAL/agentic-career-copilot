...
- [x] 2. Create data models and schemas
  - [x] 2.1 Add job-related Pydantic models to backend/app/models/schemas.py
...
- [ ] 3. Implement Job Search Service
  - [x] 3.1 Create backend/app/services/job_search.py
  ...
  - [x] 3.2 Write property test for query generation
